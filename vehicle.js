...
let seden = new Car('Toyota', 'Camry', 2022, 40, 4, 'gasoline');
let bike = new Motorcycle('Harley Davidson', 'Sportster', 2020, 70, 1200, true);

seden.rent();
console.log(`MotorCycle Rent is : ${bike.calculateRentalCost(5)}`);